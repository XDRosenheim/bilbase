...
public partial class Civic : System.Web.UI.Page
{
    ...
    protected void commentBtn_Click(object sender, EventArgs e)
    {
        if (TextBox.Text != "")
        {
            SqlRunCommandString submitComment = new SqlRunCommandString("INSERT INTO comment_Honda_Civic VALUES('" + TextBox.Text + "','" + Session["UserId"].ToString() + "',1)");
        }
        else
        {
            // Do nothing.
        ...
        Response.Redirect("/Cars/Honda/Civic.aspx");
    }
}