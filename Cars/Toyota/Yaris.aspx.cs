...
public partial class Yaris : System.Web.UI.Page
{
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        SqlRowCount rowCounter = new SqlRowCount("comment_Toyota_Yaris");
    ...
    protected void commentBtn_Click(object sender, EventArgs e)
    {
        if (TextBox.Text != "")
        {
            SqlRunCommandString submitComment = new SqlRunCommandString("INSERT INTO comment_Toyota_Yaris VALUES('" + TextBox.Text + "','" + Session["UserId"].ToString() + "',1)");
        }
        else
        {
            // Do nothing.
