...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    ...
    <asp:TextBox ID="EnterUsername_Field" runat="server"></asp:TextBox>
    <br />
    <!-- -->
    <asp:Label ID="Password_Label" runat="server" Text="Password:"></asp:Label>
    <asp:TextBox ID="EnterPassword_Field" TextMode="Password" runat="server"></asp:TextBox>
    <br />
    <!-- -->
    <asp:Label ID="RePassword_Label" runat="server" Text="Gentag password:"></asp:Label>
    <asp:TextBox ID="ReEnterPassword_Field" TextMode="Password" runat="server"></asp:TextBox>
    <br />
    <!-- -->
    <asp:Label ID="Mail_Label" runat="server" Text="Email adresse:"></asp:Label>
    <asp:TextBox ID="EnterMail_Field" runat="server"></asp:TextBox>
    <br />
    <!-- Label og textbox -->
    <asp:Label ID="Tlf_Label" runat="server" Text="Tlf nr.:"></asp:Label>
    <asp:TextBox ID="EnterTlf_Field" runat="server"></asp:TextBox>
    <br />
    <br />
    <!-- BUTTON! -->
